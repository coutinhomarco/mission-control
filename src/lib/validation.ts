...
export const createTaskSchema = z.object({
  ...
  status: z.enum(['backlog', 'inbox', 'assigned', 'in_progress', 'review', 'quality_review', 'done', 'failed']).default('inbox'),
...
export const bulkUpdateTaskStatusSchema = z.object({
  tasks: z.array(z.object({
    ...
    status: z.enum(['backlog', 'inbox', 'assigned', 'in_progress', 'review', 'quality_review', 'done', 'failed']),
